...
import javacommon.util.MapAndObject;
...
public abstract class BaseIbatisDao<E,PK extends Serializable> extends SqlMapClientDaoSupport implements EntityDao<E,PK> {
    ...
    public String pageSelectCountQuery(){
    	 return getEntityClass().getSimpleName()+".pageSelectCount";
    }
    
	public Long pageSelectCount(E entity){
		return (Long)getSqlMapClientTemplate().queryForObject(pageSelectCountQuery(),entity);
	}
	...
	public Page findByPageRequest(PageRequest pageRequest) {
		return pageQuery(getEntityClass().getSimpleName()+".pageSelect",pageRequest);
	}
	
	public void updateDynamic(E entity) {
		Object primaryKey = getSqlMapClientTemplate().update(getEntityClass().getSimpleName()+".updateDynamic", entity);
	}
	public List<E> findByDynamicWhere(E entity) {
		return getSqlMapClientTemplate().queryForList(getEntityClass().getSimpleName()+".findByDynamicWhere",entity);
	}
}
