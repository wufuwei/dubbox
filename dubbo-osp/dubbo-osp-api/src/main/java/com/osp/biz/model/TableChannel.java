...
public class TableChannel extends BaseEntity {
...
//generateConstructor END
	...
	public String toString() {
		return new StringBuffer().append("[")
			...
			.append("Channelcode").append("=").append(getChannelcode()).append(",")
			.append("Channelname").append("=").append(getChannelname()).append(",")
			.append("Channeldesc").append("=").append(getChanneldesc()).append(",")
