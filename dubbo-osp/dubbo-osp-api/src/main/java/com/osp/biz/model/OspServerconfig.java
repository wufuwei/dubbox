...
public class OspServerconfig extends BaseEntity {
...
//generateConstructor END
	...
	public String toString() {
		return new StringBuffer().append("[")
			...
			.append("Protocol").append("=").append(getProtocol()).append(",")
			.append("Url").append("=").append(getUrl()).append(",")
			.append("Serverip").append("=").append(getServerip()).append(",")
			.append("Port").append("=").append(getPort()).append(",")
